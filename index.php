...
$('body').css('margin-right', '');}
		...
		<nav class="navbar navbar-default navbar-fixed-top" id="navbar-top">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img src="images/logo-small-navbar-200px.png" id="brandlogo" class="img-responsive" alt="APHELION"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="topFixedNavbar1">
					...
					<ul class="nav navbar-nav navbar-right">
						<li><a href="#about">About Aphelion</a>
						</li>
						<li><a href="#whyneo">Why NEO</a>
						</li>
						<li><a href="/docs/aphelion-whitepaper.pdf">Whitepaper</a>
						</li>
						<li><a href="#openModal">Pre-Sale</a>
						</li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
  ...
  Aphelion tokens are an escrow utility. They are the digital smart contract mechanism powering the DEAL. </span>
			</div>
		<!-- Why Neo -->
  ...
  Compared with Ethereum, development has more smooth learning curve and shorter learning circle, allowing for fast introduction of projects.” </span>
			</div>
		<table id="card-table" class="table">
			<thead>
				<tr>
					<th width="14%">&nbsp;</th>
					<th width="20%"><img src="images/bitcoin-logo.png" alt="Bitcoin" class="img-responsive center-block">
					</th>
					<th width="20%"><img src="images/ethereum-logo.png" alt="Ethereum" class="img-responsive center-block">
					</th>
					<th width="20%"><img src="images/neo-logo-sm.png" alt="Neo" class="img-responsive center-block">
					</th>
				</tr>
			</thead>
			<tbody>
		...
		<div class="row container-fluid" id="whyneo" name="whyneo">
			...
			<table style="width:100%; margin: 10px 0;">
				...
				<tr>
					...
					<td>
						<picture> <img src="images/check-box.png" alt="Check Box" style="width:auto;"> </picture>
					</td>
					<td></td>
				</tr>
				<tr>
					...
					<div class="col-12 team-wrapper">
							...
							<div class="team-image"><img src="images/adi-benari.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/adibenari/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
						...
						<div class="team">
							<div class="team-image"><img src="images/andrew-morrell.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/andrew-morrell-8577611/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"><img src="images/colan-sewell.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list"> <a href="https://www.linkedin.com/in/colansewell/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a> </div>
								</div>
							</div>
							<div class="team-content">
								<div class="team-name">
						...
						<div class="team">
							<div class="team-image"><img src="images/aaron-levin.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/aaronlevindenvercybersecurity/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"> <a href="https://www.linkedin.com/in/joelgarcia/"><img src="images/joel-garcia.jpg" class="img-circle img-responsive"></a>
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/joelgarcia/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"><img src="images/broz.png" class="img-circle img-responsive">
								</a>
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/brozknows/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"><img src="images/josh-finkleman.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/joshuafinkleman/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"><img src="images/astrid-baldissera.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/astrid-baldissera-805b4b20/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"><img src="images/natalie-wilcox.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/natalie-wilcox-10591415/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"><img src="images/eric-liss.png" class="img-circle img-responsive">
								</a>
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/eric-liss-34376866/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
						...
						<div class="team">
							<div class="team-image"> <a href="https://www.linkedin.com/in/debuzna/"><img src="images/joe-debinza.png" class="img-circle img-responsive"></a>
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/debuzna/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
								...
								<div class="team-description">VP Engineering<br> HVR Software</div>
							</div>
						</div>
						<div class="team">
							<div class="team-image"><img src="images/cneil.jpg" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/craigneil/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
								...
								<div class="team-description">Founder Orion Technologies,<br> CTO MorCap Fund Advisors</div>
							</div>
						</div>
						<div class="team">
							<div class="team-image"><img src="images/mike-jaltuch.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/mikejaltuch/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
								...
								<div class="team-role">Founding Member</div>
								<div class="team-description">Founder Orion Technologies,<br> Linear Method Software</div>
							</div>
						</div>
						<div class="team">
							<div class="team-image"><img src="images/ian-holtz.png" class="img-circle img-responsive">
								<div class="team-links">
									<div class="team-links-list">
										<a href="https://www.linkedin.com/in/ianholtz/" target="_blank"><i class="fa fa-linkedin fa-1x " style="min-width: 10px;"></i></a>
									</div>
								</div>
							</div>
							<div class="team-content">
	...
	<div class="container" id="footer-bar">
		<div class="col-md-2"><a href="disclaimer.html">Disclaimer</a> | <a href="privacy.html">Privacy + TOS</a>
		</div>
	...
	<div id="openModal-forgot" class="modalDialog">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="post">
				<h4>Forgot Password?</h4> Enter your email address and we will send you reset instructions.
				<fieldset>
					<input placeholder="Email Address" type="email" tabindex="1" required>
				</fieldset>
				<fieldset>
	...
	<div id="openModal-thanks" class="modalDialog">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="">
				<h4>Thank You!</h4> Thank you for your interest in Aphelion. <br> A member of the team will be in touch within 24 hours.
			</form>
		</div>
	</div>
	...
	<div id="ethdeposit" class="modalDialog modalDeposit">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="">
				<h4>ETH Deposit Address</h4> 0xFBc0F99C4A1A5cc29cBE63149A49af53A7E7Ea9A
			</form>
		</div>
	</div>
	<div id="eth2deposit" class="modalDialog modalDeposit">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="">
				<h4>ETH Deposit Address</h4> 0x72454AFc75834AB95F0958b9B818058B7E425BF6
			</form>
		</div>
	</div>
	...
	<div id="btcdeposit" class="modalDialog modalDeposit">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="">
				<h4>BTC Deposit Address</h4> 3FT8xMkqC1sgtYK1Nh5k7iVexJxAP6VWcx
			</form>
		</div>
	</div>
	<div id="btc2deposit" class="modalDialog modalDeposit">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="">
				<h4>BTC Deposit Address</h4> 3JgWg92vswPatbXZQEVKgME95eVsBszGBA
			</form>
		</div>
	</div>
	...
	<div id="neodeposit" class="modalDialog modalDeposit">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="">
				<h4>NEO/GAS Deposit Address</h4> AYQyFRmwwYsYnmFQh38BNkqYk6XwF34PJp
			</form>
		</div>
	</div>
	<div id="neo2deposit" class="modalDialog modalDeposit">
		<div style="max-width: 99%!important"> <a href="#close" title="Close" class="close">X</a>
			<form id="reg" action="" method="">
				<h4>NEO/GAS Deposit Address</h4> AcvQp8DQBCi5go1oakFJiu1iAx1xEnzv9T
			</form>
		</div>
	</div>
